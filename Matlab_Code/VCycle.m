function [out]=VCycle(n, opts)
	...
	switch smoother
		...
		case 1
			[Uk,Vk,Pk] = DGS_seq(U0,V0,P0,F0,G0,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk);
		case 2
			[Uk,Vk,Pk] = DGS_seqM(U0,V0,P0,F0,G0,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk);
		case 3
			[Uk,Vk,Pk] = Uzawa(U0,V0,P0,F0,G0,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk,Alpha);
		case 4
			[Uk,Vk,Pk] = Inexact_Uzawa(U0,V0,P0,F0,G0,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk,Alpha,tau);
	end
	...
	iter_num = 0;
	while norm([resF;resG])>N^2*tol && iter_num<max_num
		Fk = RU_his{1}*resF;
		Gk = RU_his{1}*resG;
		k = 1;
		% Stage 1
		while k<n-l
			...
			switch smoother
				case 0
					[Uk, Vk, Pk] = DGS(Uk,Vk,Pk,Fk,Gk,A_his{k+1},B1_his{k+1},B2_his{k+1},BTB_his{k+1},v1);
				case 1
					[Uk, Vk, Pk] = DGS_seq(Uk,Vk,Pk,Fk,Gk,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk);
				case 2
					[Uk, Vk, Pk] = DGS_seqM(Uk,Vk,Pk,Fk,Gk,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk);
				case 3
					[Uk,Vk,Pk] = Uzawa(Uk,Vk,Pk,Fk,Gk,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk,Alpha);
				case 4
					[Uk,Vk,Pk] = Inexact_Uzawa(Uk,Vk,Pk,Fk,Gk,A_his{k+1},B1_his{k+1},B2_his{k+1},v1,Nk,Alpha,tau);
			end
			U_his{k+1}=Uk;
			V_his{k+1}=Vk;
			P_his{k+1}=Pk;
		...
		while k>0
			...
			switch smoother
				case 0
					[Uk, Vk, Pk] = DGS(Uk,Vk,Pk,Fk,Gk,A_his{k},B1_his{k},B2_his{k},BTB_his{k},v2);
				case 1
					[Uk, Vk, Pk] = DGS_seq(Uk,Vk,Pk,Fk,Gk,A_his{k},B1_his{k},B2_his{k},v2,Nk);
				case 2
					[Uk, Vk, Pk] = DGS_seqM(Uk,Vk,Pk,Fk,Gk,A_his{k},B1_his{k},B2_his{k},v2,Nk);
				case 3
					[Uk, Vk, Pk] = Uzawa(Uk,Vk,Pk,Fk,Gk,A_his{k},B1_his{k},B2_his{k},v2,Nk,Alpha);
				case 4
					[Uk,Vk,Pk] = Inexact_Uzawa(Uk,Vk,Pk,Fk,Gk,A_his{k},B1_his{k},B2_his{k},v2,Nk,Alpha,tau);
			end
			k = k-1;
		end
		resF = F0-A_his{1}*Uk-B1_his{1}*Pk;
